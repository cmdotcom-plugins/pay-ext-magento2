...
class AddMethodsAdditionalDataPaymentTest extends IntegrationTestCase
{
    ...
    public function testBeforeGetList()
    {
        ...
        $addMethodsAdditionalDataPayment->beforeGetList($subject, $magentoQuote->getId());
    ...
    public function testAfterGetList()
    {
        ...
        $actualMethods = $addMethodsAdditionalDataPayment->afterGetList($subject, $magentoMethods);
